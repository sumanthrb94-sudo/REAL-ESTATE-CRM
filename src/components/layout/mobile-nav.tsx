 ...
 * Auto-closes whenever the route changes so a tap navigates and dismisses.
 */
    ...
    <div className="md:hidden">
      ...
      {open ? (
        <div className="fixed inset-0 z-50">
          ...
          />
          {/* Drawer */}
          <aside className="absolute inset-y-0 left-0 flex w-72 max-w-[82%] flex-col border-r border-border bg-card shadow-xl">
            ...
            <div className="border-t border-border px-6 py-4 text-xs text-muted-foreground">v1.0 · Demo data</div>
          </aside>
        </div>
      ) : null}
    </div>
